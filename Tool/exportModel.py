...
def main() -> None:
    ...
    # Set up paths
    BasePath = r"C:\Users\sobha\Desktop\detectron2\Code\Auto_Sewer_Document"
    config_path = os.path.join(BasePath, "mask_rcnn_X_101_32x8d_FPN_3x.yaml")
    model_weights = os.path.join(BasePath, "model_final.pth")
    ...
    parser.add_argument("--config-file", default=config_path, metavar="FILE", help="path to config file")
    parser.add_argument("--sample-image", default=r"C:\Users\sobha\Desktop\detectron2\Data\RoboFlowData\MergeData(1-4)\split_dataset\valid\01A-3129-001A-3128-01_frame11487_png_jpg.rf.9f0d5dbf345a9081c68eb72b788c3c9c.jpg", type=str, help="sample image for input")
    parser.add_argument("--run-eval", action="store_true")
    parser.add_argument("--output", default=output_path, help="output directory for the converted model")
    parser.add_argument(
        "opts",
